...
function Navbar() {
  ...
  return (
    <nav className="grid grid-cols-2 bg-blue p-3">
      <Link href="/">
        <a className="p-2 mr-4">
          <span className="text-xl text-pink font-bold uppercase tracking-wide">Moja strona</span>
        </a>
      </Link>
    ...
    <div className="hidden lg:grid justify-self-end self-center mr-10">{navItems}</div>
    </nav>
  );
}
